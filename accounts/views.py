...
from marks.models import Mark,MarkItem
import requests
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            try:
                ...
                is_mark_item_exists = MarkItem.objects.filter(mark=mark).exists()
                print(is_mark_item_exists)
                if is_mark_item_exists:
                    mark_item = MarkItem.objects.filter(mark=mark)
